...
static struct tegra_shared_clk shared_clks[] = {
	...
	SHARED_CLK("cap.vcore.sclk", "sbus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_vcore_sclk),
	SHARED_CLK("qspi.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_qspi_sclk),
	SHARED_CLK("boot.apb.sclk", "sbus", 0, 0, 0, NULL, tegra_clk_boot_apb_sclk),
	...
	SHARED_CLK("cap.vcore.emc", "emc_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_vcore_emc),
	...
	SHARED_CLK("cap.throttle_gbus", "gbus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_throttle_gbus),
	SHARED_CLK("cap.profile_gbus", "gbus", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_profile_gbus),
	SHARED_CLK("override.gbus", "gbus", SHARED_OVERRIDE, 0, 0, NULL, tegra_clk_override_gbus),
	SHARED_CLK("floor.gbus", "gbus", 0, 0, 0, NULL, tegra_clk_floor_gbus),
	SHARED_CLK("floor.profile_gbus", "gbus", 0, 0, 0, NULL, tegra_clk_floor_profile_gbus),
	...
	SHARED_CLK("cap.host1x", "host1x_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_host1x),
	SHARED_CLK("cap.vcore.host1x", "host1x_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_vcore_host1x),
	SHARED_CLK("floor.host1x", "host1x_master", 0, 0, 0, NULL, tegra_clk_floor_host1x),
	...
	SHARED_CLK("cap.vcore.mselect", "mselect_master", SHARED_CEILING, 0, 0, NULL, tegra_clk_cap_vcore_mselect),
