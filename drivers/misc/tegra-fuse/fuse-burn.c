...
static struct tegra_fuse_hw_feature tegra186_fuse_chip_data = {
	...
	.pgm_time = 5,
	.burn_data = {
		FUSE_BURN_DATA(odm_reserved, 0x2, 2, 256, 0x1c8, true),
		FUSE_BURN_DATA(odm_lock, 0, 6, 4, 0x108, true),
		FUSE_BURN_DATA(arm_jtag_disable, 0x0, 12, 1, 0x1b8, true),
		FUSE_BURN_DATA(odm_production_mode, 0x0, 11, 1, 0x1a0, true),
		FUSE_BURN_DATA(debug_authentication, 0x5a, 0, 5, 0x2e4, true),
		FUSE_BURN_DATA(boot_security_info, 0x0, 16, 6, 0x268, true),
		FUSE_BURN_DATA(secure_boot_key, 0x4b, 23, 128, 0x1a4, false),
		FUSE_BURN_DATA(public_key, 0x43, 23, 256, 0x164, false),
		FUSE_BURN_DATA(kek0, 0x59, 22, 128, 0x3c0, false),
		FUSE_BURN_DATA(kek1, 0x5d, 22, 128, 0x3d0, false),
		FUSE_BURN_DATA(kek2, 0x61, 22, 128, 0x3e0, false),
		FUSE_BURN_DATA(odm_info, 0x50, 31, 16, 0x29c, false),
		FUSE_BURN_DATA(odm_h2, 0x67, 31, 14, 0x43c, false),
		{},
	},
};
