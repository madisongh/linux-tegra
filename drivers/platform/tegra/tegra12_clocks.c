...
struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("pwm",	"7000a000.pwm",		"pwm",	17,	0x110,	48000000, mux_pllp_pllc_clk32_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
	...
	PERIPH_CLK("hda2codec_2x",	"tegra30-hda",	"hda2codec_2x",   111,	0x3e4,	48000000,  mux_pllp_pllc_pllm_clkm,	MUX | DIV_U71 | PERIPH_ON_APB),
...
struct clk_duplicate tegra_clk_duplicates[] = {
	...
	CLK_DUPLICATE("sbc5",	"7000dc00.sbc",   "spi"),
	CLK_DUPLICATE("sbc6",	"7000de00.sbc",   "spi"),
