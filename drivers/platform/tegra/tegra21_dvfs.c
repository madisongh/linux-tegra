...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("emc",		-1, 0, 1, KHZ,        1,       1,       1,       1,       1, 1200000, 1200000, 1200000, 1200000, 1200000, 1800000),
	CORE_DVFS("emc",		-1, 1, 1, KHZ,        1,       1,       1,       1,       1, 1200000, 1200000, 1200000, 1800000, 1800000, 1800000),
	CORE_DVFS("emc",		-1, 2, 1, KHZ,        1,       1,       1,       1,       1, 1200000, 1200000, 1200000, 1800000, 1800000, 1800000),

	/* Core voltages(mV):				    875,     900,     925,     950,     975,    1000,    1025,    1050,    1075,    1100,    1125 */
	CORE_DVFS("vic03",		-1, 0, 1, KHZ,	 102400,  371200,  409600,  435200,  473600,  499200,  537600,  563200,  588800,  601600,  627200),
	CORE_DVFS("nvjpg",		-1, 0, 1, KHZ,	 102400,  371200,  409600,  435200,  473600,  499200,  537600,  563200,  588800,  601600,  627200),
	CORE_DVFS("se",			-1, 0, 1, KHZ,	 102400,  371200,  409600,  435200,  473600,  499200,  537600,  563200,  588800,  601600,  627200),
	CORE_DVFS("tsecb",		-1, 0, 1, KHZ,	 102400,  371200,  409600,  435200,  473600,  499200,  537600,  563200,  588800,  601600,  627200),
	CORE_DVFS("c2bus",		-1, 0, 1, KHZ,	 102400,  371200,  409600,  435200,  473600,  499200,  537600,  563200,  588800,  601600,  627200),

	CORE_DVFS("msenc",		-1, 0, 1, KHZ,	 153600,  435200,  473600,  512000,  563200,  601600,  601600,  652800,  678400,  691200,  716800),
	CORE_DVFS("nvdec",		-1, 0, 1, KHZ,	 153600,  435200,  473600,  512000,  563200,  601600,  601600,  652800,  678400,  691200,  716800),
	CORE_DVFS("c3bus",		-1, 0, 1, KHZ,	 153600,  435200,  473600,  512000,  563200,  601600,  601600,  652800,  678400,  691200,  716800),

	CORE_DVFS("vi",			-1, 0, 1, KHZ,	      1,  294400,  435200,  499200,  550400,  614400,  678400,  742400,  793600,  793600,  793600),
	CORE_DVFS("isp",		-1, 0, 1, KHZ,	      1,  294400,  435200,  499200,  550400,  614400,  678400,  742400,  793600,  793600,  793600),
	CORE_DVFS("cbus",		-1, 0, 1, KHZ,	      1,  294400,  435200,  499200,  550400,  614400,  678400,  742400,  793600,  793600,  793600),

	CORE_DVFS("adsp_cpu",		-1, 0, 1, KHZ,	 140800,  422400,  486400,  563200,  614400,  691200,  742400,  780800,  819200,  844800,  844800),
	CORE_DVFS("ape",		-1, 0, 1, KHZ,	 105600,  307200,  345600,  384000,  448000,  486400,  499200,  499200,  499200,  499200,  499200),

	CORE_DVFS("sbus",		-1, 0, 0, KHZ,	 102400,  243200,  268800,  294400,  320000,  345600,  358400,  371200,  384000,  408000,  408000),
	CORE_DVFS("host1x",		-1, 0, 1, KHZ,	  81600,  176130,  197470,  235870,  281600,  320000,  345600,  371200,  384000,  408000,  408000),
	CORE_DVFS("tsec",		-1, 0, 1, KHZ,	 192000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("mselect",		-1, 0, 1, KHZ,	 225500,  253800,  281500,  311400,  338300,  368800,  394600,  408000,  408000,  408000,  408000),

	CORE_DVFS("disp1",		-1, 0, 0, KHZ,	 192000,  422400,  460800,  499200,  524800,  550400,  563200,  588800,  614400,  640000,  665600),
	CORE_DVFS("disp2",		-1, 0, 0, KHZ,	 192000,  422400,  460800,  499200,  524800,  550400,  563200,  588800,  614400,  640000,  665600),

	/* Core voltages(mV):				    875,     900,     925,     950,     975,    1000,    1025,    1050,    1075,    1100,    1125 */
	CORE_DVFS("vic03",		-1, 1, 1, KHZ,	 153600,  448000,  486400,  524800,  550400,  576000,  588800,  614400,  627200,  627200,  627200),
	CORE_DVFS("nvjpg",		-1, 1, 1, KHZ,	 153600,  448000,  486400,  524800,  550400,  576000,  588800,  614400,  627200,  627200,  627200),
	CORE_DVFS("se",			-1, 1, 1, KHZ,	 153600,  448000,  486400,  524800,  550400,  576000,  588800,  614400,  627200,  627200,  627200),
	CORE_DVFS("tsecb",		-1, 1, 1, KHZ,	 153600,  448000,  486400,  524800,  550400,  576000,  588800,  614400,  627200,  627200,  627200),
	CORE_DVFS("c2bus",		-1, 1, 1, KHZ,	 153600,  448000,  486400,  524800,  550400,  576000,  588800,  614400,  627200,  627200,  627200),

	CORE_DVFS("msenc",		-1, 1, 1, KHZ,	 217600,  486400,  550400,  576000,  614400,  652800,  678400,  691200,  716800,  716800,  716800),
	CORE_DVFS("nvdec",		-1, 1, 1, KHZ,	 217600,  486400,  550400,  576000,  614400,  652800,  678400,  691200,  716800,  716800,  716800),
	CORE_DVFS("c3bus",		-1, 1, 1, KHZ,	 217600,  486400,  550400,  576000,  614400,  652800,  678400,  691200,  716800,  716800,  716800),

	CORE_DVFS("vi",			-1, 1, 1, KHZ,	      1,  384000,  588800,  678400,  691200,  691200,  691200,  793600,  793600,  793600,  793600),
	CORE_DVFS("isp",		-1, 1, 1, KHZ,	      1,  384000,  588800,  678400,  691200,  691200,  691200,  793600,  793600,  793600,  793600),
	CORE_DVFS("cbus",		-1, 1, 1, KHZ,	      1,  384000,  588800,  678400,  691200,  691200,  691200,  793600,  793600,  793600,  793600),

	CORE_DVFS("adsp_cpu",		-1, 1, 1, KHZ,	 294400,  524800,  601600,  652800,  704000,  755200,  819200,  844800,  844800,  844800,  844800),
	CORE_DVFS("ape",		-1, 1, 1, KHZ,	 140800,  371200,  409600,  422400,  460800,  499200,  499200,  499200,  499200,  499200,  499200),

	CORE_DVFS("sbus",		-1, 1, 0, KHZ,	 122800,  281600,  307200,  332800,  358400,  371200,  396800,  408000,  408000,  408000,  408000),
	CORE_DVFS("host1x",		-1, 1, 1, KHZ,	  81600,  199600,  218800,  345600,  358400,  384000,  396800,  404400,  408000,  408000,  408000),
	CORE_DVFS("tsec",		-1, 1, 1, KHZ,	 217600,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("mselect",		-1, 1, 1, KHZ,	 225500,  253800,  281500,  311400,  338300,  368800,  394600,  408000,  408000,  408000,  408000),

	CORE_DVFS("disp1",		-1, 1, 0, KHZ,	 192000,  460800,  499200,  524800,  563200,  601600,  640000,  665600,  665600,  665600,  665600),
	CORE_DVFS("disp2",		-1, 1, 0, KHZ,	 192000,  460800,  499200,  524800,  563200,  601600,  640000,  665600,  665600,  665600,  665600),

	/* Core voltages(mV):				    875,     900,     925,     950,     975,    1000,    1025,    1050,    1075,    1100,    1125 */
	CORE_DVFS("vic03",		-1, 2, 1, KHZ,	 192000,  499200,  563200,  627200,  627200,  627200,  627200,  627200,  627200,  627200,  627200),
	CORE_DVFS("nvjpg",		-1, 2, 1, KHZ,	 192000,  499200,  563200,  627200,  627200,  627200,  627200,  627200,  627200,  627200,  627200),
	CORE_DVFS("se",			-1, 2, 1, KHZ,	 192000,  499200,  563200,  627200,  627200,  627200,  627200,  627200,  627200,  627200,  627200),
	CORE_DVFS("tsecb",		-1, 2, 1, KHZ,	 192000,  499200,  563200,  627200,  627200,  627200,  627200,  627200,  627200,  627200,  627200),
	CORE_DVFS("c2bus",		-1, 2, 1, KHZ,	 192000,  499200,  563200,  627200,  627200,  627200,  627200,  627200,  627200,  627200,  627200),

	CORE_DVFS("msenc",		-1, 2, 1, KHZ,	 294400,  614400,  640000,  652800,  678400,  716800,  716800,  716800,  716800,  716800,  716800),
	CORE_DVFS("nvdec",		-1, 2, 1, KHZ,	 294400,  614400,  640000,  652800,  678400,  716800,  716800,  716800,  716800,  716800,  716800),
	CORE_DVFS("c3bus",		-1, 2, 1, KHZ,	 294400,  614400,  640000,  652800,  678400,  716800,  716800,  716800,  716800,  716800,  716800),

	CORE_DVFS("vi",			-1, 2, 1, KHZ,	 294400,  691200,  691200,  768000,  793600,  793600,  793600,  793600,  793600,  793600,  793600),
	CORE_DVFS("isp",		-1, 2, 1, KHZ,	 294400,  691200,  691200,  768000,  793600,  793600,  793600,  793600,  793600,  793600,  793600),
	CORE_DVFS("cbus",		-1, 2, 1, KHZ,	 294400,  691200,  691200,  768000,  793600,  793600,  793600,  793600,  793600,  793600,  793600),

	CORE_DVFS("adsp_cpu",		-1, 2, 1, KHZ,	 281600,  652800,  652800,  652800,  652800,  844800,  844800,  844800,  844800,  844800,  844800),
	CORE_DVFS("ape",		-1, 2, 1, KHZ,	 140800,  371200,  409600,  422400,  460800,  499200,  499200,  499200,  499200,  499200,  499200),

	CORE_DVFS("sbus",		-1, 2, 0, KHZ,	 179200,  372400,  392400,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("host1x",		-1, 2, 1, KHZ,	 115200,  385200,  385200,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("tsec",		-1, 2, 1, KHZ,	 307200,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000,  408000),
	CORE_DVFS("mselect",		-1, 2, 1, KHZ,	 225500,  253800,  281500,  311400,  338300,  408000,  408000,  408000,  408000,  408000,  408000),

	CORE_DVFS("disp1",		-1, 2, 0, KHZ,	 192000,  460800,  499200,  524800,  563200,  665600,  665600,  665600,  665600,  665600,  665600),
	CORE_DVFS("disp2",		-1, 2, 0, KHZ,	 192000,  460800,  499200,  524800,  563200,  665600,  665600,  665600,  665600,  665600,  665600),

	/* Core voltages(mV):				    875,     900,     925,     950,     975,    1000,    1025,    1050,    1075,    1100,    1125 */
	CORE_DVFS("pll_c",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c2",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c3",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_c4_out0",	-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_d_out0",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_d2",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),
	CORE_DVFS("pll_dp",		-1, -1, 1, KHZ,	 773900,  871100,  965900, 1068500, 1160800, 1265300, 1354100, 1451500, 1500000, 1500000, 1500000),

	/* Clock limits for I/O peripherals */
	/* Core voltages(mV):				    875,     900,     925,     950,     975,    1000,    1025,    1050,    1075,    1100,    1125 */
	CORE_DVFS("csi",		-1, -1, 1, KHZ,	 750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000),
	CORE_DVFS("cilab",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("cilcd",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("cile",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),

	CORE_DVFS("dsia",		-1, -1, 1, KHZ,	 500000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000),
	CORE_DVFS("dsib",		-1, -1, 1, KHZ,	 500000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000,  750000),

	CORE_DVFS("dsialp",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("dsiblp",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),

	CORE_DVFS("sor0",		-1, -1, 1, KHZ,	 270000,  270000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000,  540000),
	CORE_DVFS("sor1_src",		-1, -1, 1, KHZ,	 148500,  297000,  297000,  297000,  594000,  594000,  594000,  594000,  594000,  594000,  594000),
	CORE_DVFS("sor1",		-1, -1, 1, KHZ,	 162000,  297000,  540000,  540000,  594000,  594000,  594000,  594000,  594000,  594000,  594000),
	CORE_DVFS("i2s0",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576),
	CORE_DVFS("i2s1",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576),
	CORE_DVFS("i2s2",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576),
	CORE_DVFS("i2s3",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576),
	CORE_DVFS("i2s4",		-1, -1, 1, KHZ,	  24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576,   24576),

	CORE_DVFS("d_audio",		-1, -1, 1, KHZ,	  49152,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304,   98304),
	CORE_DVFS("spdif_out",		-1, -1, 1, KHZ,	  24576,   24728,   24728,   24728,   24728,   24728,   24728,   24728,   24728,   24728,   24728),
	CORE_DVFS("dmic1",		-1, -1, 1, KHZ,	  12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190),
	CORE_DVFS("dmic2",		-1, -1, 1, KHZ,	  12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190),
	CORE_DVFS("dmic3",		-1, -1, 1, KHZ,	  12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190,   12190),

	CORE_DVFS("hda",		-1, -1, 1, KHZ,	  51000,   51000,   51000,   51000,   51000,   51000,   51000,   51000,   51000,   51000,   51000),
	CORE_DVFS("hda2codec_2x",	-1, -1, 1, KHZ,	  48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000),
	CORE_DVFS("sdmmc2",		-1, -1, 1, KHZ,	 204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("sdmmc4",		-1, -1, 1, KHZ,	 266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000,  266000),
	CORE_DVFS("sdmmc2_ddr",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("sdmmc4_ddr",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),

	CORE_DVFS("sdmmc1",		-1, -1, 1, KHZ,	 204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("sdmmc3",		-1, -1, 1, KHZ,	 204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),

	CORE_DVFS("sdmmc1_ddr",		-1, -1, 1, KHZ,	  96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000),
	CORE_DVFS("sdmmc3_ddr",		-1, -1, 1, KHZ,	  96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000,   96000),

	CORE_DVFS("xusb_falcon_src",	-1, -1, 1, KHZ,	 336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000,  336000),
	CORE_DVFS("xusb_host_src",	-1, -1, 1, KHZ,	 112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000),
	CORE_DVFS("xusb_dev_src",	-1, -1, 1, KHZ,	 112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000,  112000),
	CORE_DVFS("xusb_ssp_src",	-1, -1, 1, KHZ,	 120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000),
	CORE_DVFS("xusb_fs_src",	-1, -1, 1, KHZ,	  48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000),
	CORE_DVFS("xusb_hs_src",	-1, -1, 1, KHZ,	 120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000,  120000),
	CORE_DVFS("usbd",		-1, -1, 1, KHZ,	 480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000),
	CORE_DVFS("usb2",		-1, -1, 1, KHZ,	 480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000),
	CORE_DVFS("usb3",		-1, -1, 1, KHZ,	 480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000,  480000),

	CORE_DVFS("sata",		-1, -1, 1, KHZ,	 102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000,  102000),
	CORE_DVFS("sata_oob",		-1, -1, 1, KHZ,	 204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000,  204000),
	CORE_DVFS("pciex",		-1, -1, 1, KHZ,	      1,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000,  500000),
	CORE_DVFS("pwm",		-1, -1, 1, KHZ,	  48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000,   48000),

	CORE_DVFS("soc_therm",		-1, -1, 1, KHZ,	 136000,  136000,  136000,  136000,  136000,  136000,  136000,  136000,  136000,  136000,  136000),
	CORE_DVFS("tsensor",		-1, -1, 1, KHZ,	  19200,   19200,   19200,   19200,   19200,   19200,   19200,   19200,   19200,   19200,   19200),
};

static struct dvfs spi_dvfs_table[] = {
	CORE_DVFS("sbc1",		-1, -1, 1, KHZ,	  35000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc2",		-1, -1, 1, KHZ,	  35000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc3",		-1, -1, 1, KHZ,	  35000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
	CORE_DVFS("sbc4",		-1, -1, 1, KHZ,	  35000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000,   65000),
};

static struct dvfs spi_slave_dvfs_table[] = {
	CORE_DVFS("sbc1",		-1, -1, 1, KHZ,	  45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000),
	CORE_DVFS("sbc2",		-1, -1, 1, KHZ,	  45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000),
	CORE_DVFS("sbc3",		-1, -1, 1, KHZ,	  45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000),
	CORE_DVFS("sbc4",		-1, -1, 1, KHZ,	  45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000,   45000),
};

static struct dvfs qspi_sdr_dvfs =
	CORE_DVFS("qspi",		-1, -1, 1, KHZ,	  81600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600,  116600);

static struct dvfs qspi_ddr_dvfs =
	CORE_DVFS("qspi",		-1, -1, 1, KHZ,	  81600,   81600,   81600,   81600,   81600,   81600,   81600,   81600,   81600,   81600,   81600);
