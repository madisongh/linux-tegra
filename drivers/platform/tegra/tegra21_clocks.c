...
static struct clk tegra_list_clks[] = {
	PERIPH_CLK("ahbdma",	"ahbdma",		NULL,	33,	0,	38400000,  mux_clk_m,			0, 0),
	...
	PERIPH_CLK("sbc1",	"spi-tegra114.0",	NULL,	41,	0x134,  65000000, mux_pllp_pllc_clkm,	MUX | DIV_U71 | PERIPH_ON_APB, TEGRA210_CLK_ID_SBC1),
	...
	PERIPH_CLK("i2c1",	"tegra21-i2c.0",   "div-clk",	12,	0x124,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C1),
	PERIPH_CLK("i2c2",	"tegra21-i2c.1",   "div-clk",	54,	0x198,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C2),
	PERIPH_CLK("i2c3",	"tegra21-i2c.2",   "div-clk",	67,	0x1b8,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C3),
	PERIPH_CLK("i2c4",	"tegra21-i2c.3",   "div-clk",	103,	0x3c4,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C4),
	PERIPH_CLK("i2c5",	"tegra21-i2c.4",   "div-clk",	47,	0x128,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C5),
	PERIPH_CLK("i2c6",	"tegra21-i2c.5",   "div-clk",	166,	0x65c,	136000000, mux_pllp_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2C6),
	PERIPH_CLK("vii2c",	"tegra21-i2c.6",   "vii2c",	208,	0x6c8, 136000000, mux_pllp_pllc_clkm,	MUX | DIV_U16 | PERIPH_ON_APB, 0),
	PERIPH_CLK("i2cslow",	"tegra21-i2c.6",   "i2cslow",	81,	0x3fc,	50000000,  mux_pllp_pllc_clk32_clkm,	MUX | DIV_U71 | PERIPH_ON_APB, TEGRA210_CLK_ID_I2CSLOW),
