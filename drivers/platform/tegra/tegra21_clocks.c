...
static struct clk tegra_list_clks[] = {
	...
	PERIPH_CLK("uartd",	"serial-tegra.3",	NULL,	65,	0x1c0, 1190400000, mux_pllp_pllc_pllc4_out0_pllc4_out1_clkm_pllc4_out2,	MUX | DIV_U151 | DIV_U151_UART | PERIPH_ON_APB, 0),
